s <?php
 ...
 ?>
  ...
  <div class="bottomboxTable">
          ...
          <span style="font-size:30px; font-weight:bold;">বই মেলা ২০১১ এর <?php echo "<span style='font-size:39px;'>" . $bn->make_bangla_number($dm)  ."</span>". " " . $tit ; ?> ফেব্রুয়ারি প্রকাশিত বই  </span> <br><br>
         <?php 
          }
          else
          {
		  ...
		  ?>
			 ...
			 if($ls == 0) {
              ...
              <a href="bookpage2.php?c=<?php echo $cat; ?>&d=<?php echo $dm ; ?>&ls=<?php echo $lp ;?> "> 
                 <div class="next6" >
                  &nbsp;
                 </div> 
              </a>
			 ...
			 if($ls >= $nu ) {
				?> 
                  <a href="bookpage2.php?c=<?php echo $cat; ?>&d=<?php echo $dm ; ?>&ls=<?php echo $lm ;?> "> 
                 <div class="prev6" >
                  &nbsp;
                 </div> 
              </a>
