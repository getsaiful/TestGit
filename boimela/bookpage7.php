 ...
 ?>
  ...
  <div class="bottomboxTable">
          ...
          ?>  
          <span style="font-size:23px; font-weight:bold;font-family:'SolaimanLipiNormal';">বই মেলা ২০১৫ এর <?php echo "<span style='font-size:35px;'>" . $bn->make_bangla_number($dm)  ."</span>". " " . $tit ; ?> ফেব্রুয়ারি প্রকাশিত বই  </span> <br><br>
         <?php 
          }
		  ...
		  ?>
			 ...
			 if($ls == 0) {
			  ...
			  if($num > 10) {
				 ?> 
				 <a href="bookpage7.php?c=<?php echo $cat; ?>&d=<?php echo $dm ; ?>&ls=<?php echo $lp ;?> "> 
                 <div class="next6" >
                  &nbsp;
                 </div> 
              </a>
			 ...
			 if($ls >= $nu ) {
				?> 
                  <a href="bookpage7.php?c=<?php echo $cat; ?>&d=<?php echo $dm ; ?>&ls=<?php echo $lm ;?> "> 
                 <div class="prev6" >
                  &nbsp;
                 </div> 
              </a>
