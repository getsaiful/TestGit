 ...
 ?>
  ...
  <div class="bottombox2" style="margin-top:20px;">
          ...
          <div class="toprow2" style="margin-top:95px;">
               <a href="bookpage5.php?d=1&c=3" class="imglink"> <img src="image/1.png" name="img1" border="0"   onmouseover="myOn('img1')"  onmouseout="myOut('img1')" /> </a>
               
                <?php
				if($d >= 2) {
				?>
                
                <a href="bookpage5.php?d=2&c=3" class="imglink"> <img src="image/2.png" name="img2" border="0"   onmouseover="myOn('img2')"  onmouseout="myOut('img2')" /> </a>
                <?php } else{ ?>
                <img src="img/2+++.png"  border="0"  />
                
                <?php } if($d >= 3 ) {?>
                <a href="bookpage5.php?d=3&c=3" class="imglink"> <img src="image/3.png" name="img3" border="0"   onmouseover="myOn('img3')"  onmouseout="myOut('img3')" /> </a>
                <?php } else{ ?>
                <img src="img/3+++.png"  border="0"  />
			   <?php } if($d >= 4 ) {
					?>
                <a href="bookpage5.php?d=4&c=3" class="imglink"> <img src="image/4.png" name="img4" border="0"  onmouseover="myOn('img4')"  onmouseout="myOut('img4')" /> </a>
				<?php
				}
				else   {
                ?>
                ...
                <a href="bookpage5.php?d=5&c=3" class="imglink"> <img src="image/5.png" name="img5" border="0"   onmouseover="myOn('img5')"  onmouseout="myOut('img5')" /> </a>
                <?php
				}
				else   {
                ?>
				...
				if($d >= 6 ) {
					?>
                  <a href="bookpage5.php?d=6&c=3" class="imglink"> <img src="image/6.png" name="img6" border="0"   onmouseover="myOn('img6')"  onmouseout="myOut('img6')" /> </a>
                  <?php
				}
				else   {
                ?>
				...
				if($d >= 7 ) {
					?>
                <a href="bookpage5.php?d=7&c=3" class="imglink"> <img src="image/7.png" name="img7" border="0"   onmouseover="myOn('img7')" onMouseOut="myOut('img7')" /> </a>
                <?php
				}
				else   {
                ?>
				...
				if($d >= 8 ) {
					?>
                <a href="bookpage5.php?d=8&c=3" class="imglink"> <img src="image/8.png" name="img8" border="0"   onmouseover="myOn('img8')"  onmouseout="myOut('img8')" /> </a>
                <?php
				}
				else   {
                ?>
				...
				if($d >= 9 ) {
					?>
                <a href="bookpage5.php?d=9&c=3" class="imglink"> <img src="image/9.png" name="img9" border="0"  onmouseover="myOn('img9')"  onmouseout="myOut('img9')" /> </a>
                 <?php
				}
				else   {
                ?>
				...
				if($d >= 10 ) {
					?>
                <a href="bookpage5.php?d=10&c=3" class="imglink"> <img src="image/10.png" name="img10" border="0"   onmouseover="myOn('img10')"  onmouseout="myOut('img10')" /> </a>
                <?php
				}
				else   {
                ?>
			  ...
			  if($d >= 11 ) {
					?>
                 <a href="bookpage5.php?d=11&c=3" class=" imglink"> <img src="image/11.png" name="img11" border="0"   onmouseover="myOn('img11')"  onmouseout="myOut('img11')" /> </a>
                 <?php
				}
				else   {
                ?>
				...
				if($d >= 12 ) {
					?>
                <a href="bookpage5.php?d=12&c=3" class=" imglink"> <img src="image/12.png" name="img12" border="0"   onmouseover="myOn('img12')" onMouseOut="myOut('img12')" /> </a>
                <?php
				}
				else   {
                ?>
				...
				if($d >= 13 ) {
					?>
                <a href="bookpage5.php?d=13&c=3" class=" imglink"> <img src="image/13.png" name="img13" border="0"   onmouseover="myOn('img13')"  onmouseout="myOut('img13')" /> </a>
                <?php
				}
				else   {
                ?>
				...
				if($d >= 14 ) {
					?>
                <a href="bookpage5.php?d=14&c=3" class=" imglink"> <img src="image/14.png" name="img14" border="0"  onmouseover="myOn('img14')"  onmouseout="myOut('img14')" /> </a>
                <?php
				}
				else   {
                ?>
				...
				if($d >= 15 ) {
					?>
                <a href="bookpage5.php?d=15&c=3" class=" imglink"> <img src="image/15.png" name="img15" border="0"   onmouseover="myOn('img15')"  onmouseout="myOut('img15')" /> </a>
                <?php
				}
				else   {
                ?>
				...
				if($d >= 16 ) {
					?>
                         <a href="bookpage5.php?d=16&c=3" class=" imglink"> <img src="image/16.png" name="img16" border="0"   onmouseover="myOn('img16')"  onmouseout="myOut('img16')" /> </a>
                         <?php
				}
				else   {
                ?>
				...
				if($d >= 17 ) {
					?>
                <a href="bookpage5.php?d=17&c=3" class=" imglink"> <img src="image/17.png" name="img17" border="0"   onmouseover="myOn('img17')" onMouseOut="myOut('img17')" /> </a>
                <?php
				}
				else   {
                ?>
				...
				if($d >= 18 ) {
					?>
                <a href="bookpage5.php?d=18&c=3" class=" imglink"> <img src="image/18.png" name="img18" border="0"   onmouseover="myOn('img18')"  onmouseout="myOut('img18')" /> </a>
                <?php
				}
				else   {
                ?>
				...
				if($d >= 19 ) {
					?>
                <a href="bookpage5.php?d=19&c=3" class=" imglink"> <img src="image/19.png" name="img19" border="0"  onmouseover="myOn('img19')"  onmouseout="myOut('img19')" /> </a>
                <?php
				}
				else   {
                ?>
				...
				if($d >= 20 ) {
					?>
                <a href="bookpage5.php?d=20&c=3" class=" imglink"> <img src="image/20.png" name="img20" border="0"   onmouseover="myOn('img20')"  onmouseout="myOut('img20')" /> </a>
                <?php
				}
				else   {
                ?>
				...
				?>
				 ...
				 if($d >= 21 ) {
					?>
               <a href="bookpage5.php?d=21&c=3" class=" imglink"> <img src="image/21.png" name="img21" border="0"   onmouseover="myOn('img21')"  onmouseout="myOut('img21')" /> </a>
               <?php
				}
				else   {
                ?>
                ...
                <a href="bookpage5.php?d=22&c=3" class=" imglink"> <img src="image/22.png" name="img22" border="0"   onmouseover="myOn('img22')" onMouseOut="myOut('img22')" /> </a>
                <?php
				}
				else   {
                ?>
				...
				if($d >= 23 ) {
					?>
                <a href="bookpage5.php?d=23&c=3" class=" imglink"> <img src="image/23.png" name="img23" border="0"   onmouseover="myOn('img23')"  onmouseout="myOut('img23')" /> </a>
                <?php
				}
				else   {
                ?>
				...
				if($d >= 24 ) {
					?>
                <a href="bookpage5.php?d=24&c=3" class=" imglink"> <img src="image/24.png" name="img24" border="0"  onmouseover="myOn('img24')"  onmouseout="myOut('img24')" /> </a>
                <?php
				}
				else   {
                ?>
				...
				if($d >= 25 ) {
					?>
                <a href="bookpage5.php?d=25&c=3" class=" imglink"> <img src="image/25.png" name="img25" border="0"   onmouseover="myOn('img25')"  onmouseout="myOut('img25')" /> </a>   
                <?php
				}
				else   {
                ?>
				...
				if($d >= 26 ) {
					?>
               <a href="bookpage5.php?d=26&c=3" class="imglink"> <img src="image/26.png" name="img26" border="0"   onmouseover="myOn('img26')"  onmouseout="myOut('img26')" /> </a>
               <?php
				}
				else   {
                ?>
				...
				if($d >= 27 ) {
					?>
                <a href="bookpage5.php?d=27&c=3" class="imglink"> <img src="image/27.png" name="img27" border="0"   onmouseover="myOn('img27')" onMouseOut="myOut('img7')" /> </a>
                <?php
				}
				else   {
                ?>
				...
				if($d >= 28 ) {
					?>
                <a href="bookpage5.php?d=28&c=3" class="imglink"> <img src="image/28.png" name="img28" border="0"   onmouseover="myOn('img28')"  onmouseout="myOut('img28')" /> </a>
                <?php
				}
				else   {
                ?>
