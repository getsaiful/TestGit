 ...
 ?>
  ...
  <div class="bottomboxTable">
          ...
          <span style="font-size:24px; font-weight:bold;font-family: 'SolaimanLipiNormal';">বই মেলা ২০১২ এর <?php echo "<span style='font-size:35px;'>" . $bn->make_bangla_number($dm) ."</span>". " " . $tit ; ?> ফেব্রুয়ারি প্রকাশিত বই  </span> <br><br>
         <?php 
          }
          else
          {
          ?>
                 <span style="font-size:30px; font-weight:bold;font-family: 'SolaimanLipiNormal';">বই মেলা ২০১০ এর বই -এর তালিকা সমূহ</span> <br><br>
                 <?php
		  }
		  ?>
             </div>
			 ...
			 if($ls == 0) {
			  ...
			  if($num > 10) {
				 ?> 
				 <a href="bookpage4.php?c=<?php echo $cat; ?>&d=<?php echo $dm ; ?>&ls=<?php echo $lp ;?> "> 
                 <div class="next6" >
                  &nbsp;
                 </div> 
              </a>
			 ...
			 if($ls >= $nu ) {
				?> 
                  <a href="bookpage4.php?c=<?php echo $cat; ?>&d=<?php echo $dm ; ?>&ls=<?php echo $lm ;?> "> 
                 <div class="prev6" >
                  &nbsp;
                 </div> 
              </a>
	  ...
	  <tr class="light_bg" style="font-weight:bold;font-family: 'SolaimanLipiNormal';">
