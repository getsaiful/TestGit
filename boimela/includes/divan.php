...
if($_REQUEST['uploaded'])
{
	...
	$qry_insert = mysql_query("insert into tbl_products values('".$titleID."', '".$_REQUEST['pro_title']."', '".$photofile."', '3')");
	if($qry_insert)
		{
			header("Location: admincp.php?detail=divan");	
		}
		else
		{
			$msg = 'Insert Failed!';	
  ...
  <tr>
    <td align="center" valign="top">
    	<table border="0" align="left" width="100%">
         <tr>
            <td style="padding:10px 10px 0 10px; font-size:16px; font-weight:bold">Divan</td>
          </tr>
          <tr>
          	<td>
            	<table width="100%" border="0">
                  <tr>
                    <td align="center">
                        ...
                        <tr>
                       		<td height="23"  align="right" style="padding-right:15px;">&nbsp;<a href="admincp.php?detail=divan&view=add_new">Add New Photo</a></td>
                        </tr>                        
				...
				header("Location: admincp.php?detail=divan");				
          	      ...
          	      <?php 
				    $qry = "select * from tbl_products where cat=3";
          	      ...
          	      <tr>
                    	...
                    	<table width="100%" border="0">
                          <tr>
                             ...
                             <td width="29%" align="left"><a href="admincp.php?detail=divan&view=edit_view&pro_id=<?php echo $fetch_array['id'];  ?>" class="action">Edit</a> | <a href="admincp.php?detail=divan&view=del&pro_id=<?php echo $fetch_array['id'];  ?>" class="action">Delete</a></td>
                          </tr>
                        </table>
                    </td>                   
        	        </tr>
				    ...
				    <tr>
                      <td style="padding-left:8px; padding-top:10px; padding-bottom:10px;">
                          <?php 
								...
								$pager = new PS_Pagination($dblink, $qry, 15, 5, 'detail=divan&n=2&cat=3');
