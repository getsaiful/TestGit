...
if(isset($_POST['btnAdd'])){
	...
	if($_GET[event]=='view')
	{
		...
		$resqltview=mysql_fetch_array($exeview);
			...
			<table width="100%"  border="0" cellspacing="0" cellpadding="0" style="padding:10px 0px 10px 0px;">
			  ...
			  <tr>
				<td style="padding-top:10px;"><font class="innerBold2">Published Date : </font><?php echo date('F d, Y',strtotime($resqltview['published_date']));?></td>
			  </tr>			  
			</table>
            <?php 					
		}
	...
	<form name="frmEdit" method="post">
		<table width="520"  border="0" cellspacing="0" cellpadding="6">
		   <tr>
			<td width="109" align="right">Book Type  </td>
			<td width="387">: &nbsp;&nbsp;
                                         <select name="b_type" >
                                             <option value=""> ????? ???? ???? ???? ????? ????  </option>
                                             <option value="">---------------------</option>
          ...
          <tr>
			<td width="109" align="right">Photo  </td>
