	...
	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
	  <tr>	  	
		...
		<div style="float:right;padding:0px 0px 4px 0px;">
			<a  class="fontclass" href="tikar.php?event=add" style="text-decoration:none; color:#626262;"><img src="images/arrow2.jpg" width="10" height="11"  border="0"/> &nbsp;  নাতুন ছবি সংগ্রহ </a>
		</div>
		</td>
	  </tr>
	</table>	
