 ...
 if(empty($_SESSION['uid']) || empty($_SESSION['uname']) )
{
 ...
 if(isset($_POST['update'])){
	...
	if($ufile) {
		...
		if($_GET['event'] == 'add') {
			?>
			 <form name="frmadd" method="post" action="map.php" enctype="multipart/form-data">
...
?>
 <form name="frmEdit" method="post" action="map.php" enctype="multipart/form-data">
	...
	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
	  <tr>	  	
		...
		<div style="float:right;padding:0px 0px 4px 0px;">
			<a  class="fontclass" href="map.php?event=add" style="text-decoration:none; color:#626262;"><img src="images/arrow2.jpg" width="10" height="11"  border="0"/> &nbsp;  নতুন ম্যাপ সংগ্রহ </a>
		</div>
		</td>
	  </tr>
	</table>	
